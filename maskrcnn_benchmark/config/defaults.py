...
_C.DATASETS.TEST = ()
_C.DATASETS.TO_TEST = 'train' # 原None
...
_C.MODEL.ROI_RELATION_HEAD.PENET_MLP_DIM = 2048
_C.MODEL.ROI_RELATION_HEAD.PENET_EMBED_DIM = 300
_C.MODEL.ROI_RELATION_HEAD.PENET_DROPOUT = 0.2
...
_C.MODEL.ROI_RELATION_HEAD.SEM_PRO_MODE = True
# Visual Prototype
_C.MODEL.ROI_RELATION_HEAD.VIS_PRO_MODE = True
_C.MODEL.ROI_RELATION_HEAD.VIS_PRO_DIM = 4096
_C.MODEL.ROI_RELATION_HEAD.STORE_UNION = False # True only for visual prototype initialization
_C.MODEL.ROI_RELATION_HEAD.VIS_VAE_LATENT_DIM = 1024
_C.MODEL.ROI_RELATION_HEAD.VIS_VAE_INPUT_DIM = 4096
_C.MODEL.ROI_RELATION_HEAD.VIS_PRO_PATH = './output/relation_baseline/vg_vis_protos.pt'
# Conceptual Prototype
_C.MODEL.ROI_RELATION_HEAD.CON_PRO_MODE = True
_C.MODEL.ROI_RELATION_HEAD.CON_PRO_DIM = 4096        # 2304 for CLIP, 4096 for LLAMA
_C.MODEL.ROI_RELATION_HEAD.CON_VAE_LATENT_DIM = 1024 # 576 for CLIP, 1024 for LLAMA
_C.MODEL.ROI_RELATION_HEAD.CON_VAE_INPUT_DIM = 4096  # 2304 for CLIP, 4096 for LLAMA
_C.MODEL.ROI_RELATION_HEAD.CON_PRO_TYPE = 'LLAMA'    # 'CLIP', 'LLAMA'
_C.MODEL.ROI_RELATION_HEAD.CON_PRO_CLIP_PATH = './output/relation_baseline/vg_clip_refine_con_protos.pt'
_C.MODEL.ROI_RELATION_HEAD.CON_PRO_LLAMA_PATH = './output/relation_baseline/vg_llama_con_protos.pt'

_C.MODEL.USE_REWEIGHT = 'PENET' # or none
