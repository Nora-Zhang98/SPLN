...
def do_vg_evaluation(
    ...
    zeroshot_triplet = torch.load("/home/stormai/userfile/zrn/PENET/maskrcnn_benchmark/data/datasets/evaluation/vg/zeroshot_triplet.pytorch", map_location=torch.device("cpu")).long().numpy()
